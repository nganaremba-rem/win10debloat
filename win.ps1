...
# If not running as an administrator, relaunch the script with elevated privileges
if (-not $isAdmin) {
    # Create a new process start info object
    $processInfo = New-Object System.Diagnostics.ProcessStartInfo

    # Set the properties of the process start info object
    $processInfo.FileName = 'powershell.exe'
    $processInfo.Arguments = "-ExecutionPolicy Bypass -File `"$PSCommandPath`""
    $processInfo.Verb = 'RunAs'

    # Start a new process with the process start info object
